...
/*
      var data = [
                [//A3
                  {axis:"MPG",value:0.675},
                  {axis:"Torque",value:0.60},
                  {axis:"Horsepower",value:0.42},
                  {axis:"Reliability",value:0.629},
                  {axis:"Whellbase",value:0.5}
                  			
                ],[//q5
                    {axis:"MPG",value:0.4},
                    {axis:"Torque",value:0.865},
                    {axis:"Horsepower",value:0.74},
                    {axis:"Reliability",value:0.686},
                    {axis:"Whellbase",value:0.75}
                ]
              ];
*/
      ////////////////////////////////////////////////////////////// 
...
.row(function(d) { return{
  ...
  console.log(final_data) 
    ...
    /* console.log(data1) 
		var data = data.filter(function(d){ return d.model == "A3" || d.model == "A4" });
    var dataset = data.map(function(data){
        return{
            mpg: Number(data.mpg),
            torque: Number(data.torque),
            horsepower: Number(data.horsepower),
            reliability: Number(data.reliability),
            wheelbase: Number(data.wheelbase)
        }
  ...
  /*
    ...
    //console.log(dataset[0].mpg)
    var final_data = [
        [//A3
          {axis:"MPG",value:dataset[0].mpg},
          {axis:"Torque",value:dataset[0].torque},
          {axis:"Horsepower",value:dataset[0].horsepower},
          {axis:"Reliability",value:dataset[0].reliability},
          {axis:"Whellbase",value:dataset[0].wheelbase}
                      
        ],[//q5
            {axis:"MPG",value:dataset[1].mpg},
            {axis:"Torque",value:dataset[1].torque},
            {axis:"Horsepower",value:dataset[1].horsepower},
            {axis:"Reliability",value:dataset[1].reliability},
            {axis:"Whellbase",value:dataset[1].wheelbase}
        ]
      ];
    console.log(final_data) 
      //RadarChart(".radarChart", final_data, radarChartOptions)
